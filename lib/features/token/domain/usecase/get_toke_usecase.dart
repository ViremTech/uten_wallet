// features/token/domain/usecases/get_tokens.dart
...
class GetTokens implements Usecase<List<TokenEntity>, int> {
  final TokenRepository repository;

  GetTokens(this.repository);

  @override
  Future<Either<Failure, List<TokenEntity>>> call(int chainId) async {
    return await repository.getTokens(chainId);
  }
}
